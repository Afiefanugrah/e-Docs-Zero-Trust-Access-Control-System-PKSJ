...
router.delete("/slug/:slug", auth_middleware_1.authenticateToken, (0, auth_middleware_1.authorizeRole)(["admin"]), // <-- HANYA ADMIN BISA HAPUS
documents_controller_1.default.deleteDocumentBySlug.bind(documents_controller_1.default));
